      ...
      <Container>
        <FadeIn className="mx-auto max-w-2xl text-center">
          ...
          <a
            ...
            className="mt-8 inline-flex items-center gap-2.5 rounded-full border border-mocha/15 bg-white px-5 py-2.5 text-sm font-medium text-warm-dark shadow-[0_2px_8px_rgba(0,0,0,0.04)] transition-all duration-150 hover:border-mocha/30 hover:bg-surface-100 hover:shadow-[0_4px_12px_rgba(0,0,0,0.06)]"
          >
